...
{
    public partial class AddInventoryDialog : UserControl, IDialogUserControl
    {
        ...
        {
            if (!Int32.TryParse(e.Text, out int result))
            {
                e.Handled = true;
            }
            //TODO: fix so text pasted in is also validated
        }
    }
}
